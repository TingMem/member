...
<div style="margin:0px 2%;">
    <form id="form2" name="form2" method="post" action="<?php echo U('TypeReset');?>">
        <table class="table table-bordered" width="96%" style="background:#fff;"  cellpadding="0">
          ...
          <?php if(is_array($typelist)): $i = 0; $__LIST__ = $typelist;if( count($__LIST__)==0 ) : echo "$msg" ;else: foreach($__LIST__ as $key=>$at): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td align="center" width="80px" >
                ...
                <input type="text" class="form-control" name="weight[]" value="<?php echo ($at["weight"]); ?>"></td>
              <td width="200px" align="center" > - </td>
            </tr><?php endforeach; endif; else: echo "$msg" ;endif; ?>
        </table>
        <div style="text-align: center;"></div>
        <div style="text-align: center;">
          <input ac='<?php echo U("TypeDel");?>' name="submitbtn" class="btn btn-primary btn-sub" onclick="return confirm('您确定要恢复选中的分类吗？')" value="恢复分类" type="submit" />
        </div>
    </form> 
