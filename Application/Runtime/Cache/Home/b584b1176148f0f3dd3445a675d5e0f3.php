...
<div style="margin:0px 2%;">
    <form id="form2" name="form2" method="post" action="<?php echo U('AttrDel');?>">
      <ul>
        <table class="table table-bordered" width="96%" style="background:#fff;"  cellpadding="0">
          <tr>
            ...
            <td align="center" >编号ID</td>
            <td align="center" >所属分类</td>
            <td align="center" >属性名</td>
            <td align="center" >状态</td>
            <td align="center" >属性值</td>
            <td align="center" >容器类型</td>
            <td align="center" >操作</td>
          </tr>
          <?php if(is_array($attrlist)): $i = 0; $__LIST__ = $attrlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$at): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td align="center" ><?php echo ($at["attr_name"]); ?></td>
              <td align="center" ><?php if($at["attr_status"] == 1): ?>启用<?php else: ?><span style="color: red">停用</span><?php endif; ?></td>
              <td align="center" ><?php echo ($at["attr_valuesid"]); ?></td>
              <td align="center" ><?php if($at["attr_text_type"] == "list"): ?>下拉菜单<?php else: ?>单行文本<?php endif; ?></td>
              <td width="200px" align="center" > 
              <a href="AttrEdit/id/<?php echo ($at["id"]); ?>"><button class="btn btn-default" type="button"><i alt='编辑' title='编辑' class="glyphicon glyphicon-pencil "></i>编辑</button></a> - 
                <a href="AttrDel/attrid/<?php echo ($at["id"]); ?>"><button class="btn btn-default " onclick="return confirm('您确定要删除选中的属性吗？')" type="button"><i alt='删除' title="删除" style="color: red ; margin-left:20;" class="glyphicon glyphicon-remove"></i>删除</button></a>
               </td>
            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
        </table>
        <div style="text-align: center;"></div>
        <div style="text-align: center;">
          <a href="<?php echo U('StoreProductAttr/AttrAdd');?>"><input  name="submitbtn" class="btn btn-primary" value="添加属性" type="button" /></a> - 
          <a href="AttrDel"><input  name="submitbtn" class="btn btn-primary" onclick="return confirm('您确定要删除选中的属性吗？')" value="删除选中" type="submit" /></a>
