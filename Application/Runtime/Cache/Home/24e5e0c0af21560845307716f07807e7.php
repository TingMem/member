    ...
    <form id="form2" name="form2" method="post" action="">
      <ul>
        <table class="table-bordered" width="100%" border="0" style="background:#ccc;" cellspacing="1" cellpadding="0">
          <tr>
            <td width="80" align="center" bgcolor="#EFEFEF">ID</td>
            <td width="150" height="35" align="center" bgcolor="#EFEFEF">作者</td>
            <td width="350" align="center" bgcolor="#EFEFEF">备注</td>
            <td width="100" align="center" bgcolor="#EFEFEF">发布日期</td>
          ...
          <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lists): $mod = ($i % 2 );++$i;?><tr>
              <td width="150" align="center" bgcolor="#FFFFFF"><?php echo ($lists["id"]); ?></td>
              <td width="150" height="35" align="center" bgcolor="#FFFFFF"><?php echo ($lists["admins"]); ?></td>
              <td width="350" align="center" bgcolor="#FFFFFF"><?php echo ($lists["title"]); ?></td>
              <td width="100" align="center" bgcolor="#FFFFFF"><?php echo (date('Y-m-d',$lists["uptime"])); ?></td>
              <td align="center" bgcolor="#FFFFFF"><?php echo (mb_substr(strip_tags($lists["content"]),0,200,'utf-8')); ?></td>
              <td align="center" bgcolor="#FFFFFF"><a href="<?php echo U('manage/about_edit',array('id'=>$lists["id"],'tid'=>I('get.tid'),'thisid'=>I('get.thisid')));?>">编辑</a></td>
