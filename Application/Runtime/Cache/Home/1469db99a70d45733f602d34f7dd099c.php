...
<!-- AdminLTE for demo purposes -->
    ...
    <!-- Main content -->
<div class="search">
  <form id="form1" name="form1" method="post" action="/index.php/home/index/search/}">
    
    <table  style="margin:20px auto;" width="500" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="20%"><div style="font-size:18px; font-weight:bold">商家搜索</div></td>
        <td width="60%"><input style="height:30px; line-height:30px; padding:5px; border-radius:5px; border:1px solid #ccc; width:250px;" placeholder="输入商家名搜索" type="text" name="search" id="search" /></td>
        <td width="10%"><input type="submit" class="sub btn btn-primary" name="sub" id="sub" value="搜 索" /></td>
      </tr>
    </table>
  </form>
</div>
<div>
  ...
  <ul style="margin:0;">
    <form id="form2" name="form2" method="post" action="">
      <ul>
        <table class="table-bordered" width="100%" border="0" style="background:#ccc;" cellspacing="1" cellpadding="0">
          <tr>
            <td width="50" height="35" align="center" bgcolor="#fafafa"><input type="checkbox" name="all" id="all" />
              <label for="all"></label></td>
            <td width="260" align="center" bgcolor="#EFEFEF">商家名</td>
            <td width="150" align="center" bgcolor="#EFEFEF">头像</td>
            <td width="150" align="center" bgcolor="#EFEFEF">商家帐号</td>
            <td width="100" align="center" bgcolor="#EFEFEF">折扣点</td>
            <td width="120" align="center" bgcolor="#EFEFEF">结算周期</td>
            <td width="120" align="center" bgcolor="#EFEFEF">合约状态</td>
            <td width="160" align="center" bgcolor="#EFEFEF">原价</td>
            <td width="120" align="center" bgcolor="#EFEFEF">折扣价</td>
            <td align="center" bgcolor="#EFEFEF">联系电话</td>
            <td width="100" align="center" bgcolor="#EFEFEF">操作</td>
          </tr>
          <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lists): $mod = ($i % 2 );++$i;?><tr>
              <td width="50" height="35" align="center" bgcolor="#FFFFFF"><input type="checkbox" value="<?php echo ($lists["id"]); ?>" class="select" name="select[]" id="select[]" /></td>
              <td width="260" align="center" bgcolor="#FFFFFF"><?php echo ($lists["usercname"]); ?></td>
              <td width="150" align="center" bgcolor="#FFFFFF"><img width="80" height="80" src="<?php echo ((isset($lists["avatar"]) && ($lists["avatar"] !== ""))?($lists["avatar"]):'/Public/images/avatar/default.jpg'); ?>" /></td>
              <td width="150" align="center" bgcolor="#FFFFFF"><?php echo ($lists["username"]); ?></td>
              <td width="100" align="center" bgcolor="#FFFFFF"><?php echo ($lists["zhekou"]); ?></td>
              <td width="120" align="center" bgcolor="#FFFFFF"><?php echo ((isset($lists["jiesuan"]) && ($lists["jiesuan"] !== ""))?($lists["jiesuan"]):0); ?>天</td>
              <td width="120" align="center" bgcolor="#FFFFFF"><?php if($lists["status"] == 1): ?><font style="color:green">合作中</font>
                <?php else: ?>
                <font style="color:red">尚未合作</font><?php endif; ?></td>
              <td width="160" align="center" bgcolor="#FFFFFF"><?php echo ($lists["yuanjia"]); ?></td>
              <td width="120" align="center" bgcolor="#FFFFFF"><?php echo ($lists["zhekoujia"]); ?></td>
              <td align="center" bgcolor="#FFFFFF"><?php echo ($lists["tel"]); ?></td>
              <td width="100" align="center" bgcolor="#FFFFFF"><span class="fonts"><a href="/index.php/home/index/listedit/id/<?php echo ($lists["id"]); ?>">编辑</a></span></td>
            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
        </table>
        <div class="pagelist">
          <input  name="tijiao" class="delsub btn btn-primary" value="删除选中" type="submit" /> - 
          <input name="tijiao2" class="edit btn btn-primary" value="合作反向操作" type="submit" />
          <span class="fonts">（<span class="fonts">取消合作或者开启合作，如同时选择两种合作状态操作，则互相进行反向设置。例：A商家为合作中，B商家未合作，两个同时进行合作反向操作。结果：A变为未合作，B为合作中。）</span></span></div>
      </ul>
    </form>
    <div class="pagelists"><?php echo ($page); ?></div>
  </ul>
</div>
    <!-- /.content -->
	</div>
