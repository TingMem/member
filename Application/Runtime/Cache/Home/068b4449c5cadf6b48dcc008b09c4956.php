...
<div style="margin:0px 2%;">
    <form id="form2" name="form2" method="post" action="<?php echo U('SpecDel');?>">
      <ul>
        <table class="table table-bordered" width="96%" style="background:#fff;"  cellpadding="0">
          <tr>
            ...
            <td align="center" >规格名</td>
            <td align="center" >状态</td>
            <td align="center" >价格</td>
            <td align="center" >所属分类</td>
            <td align="center" >操作</td>
          </tr>
          <?php if(is_array($spec)): $i = 0; $__LIST__ = $spec;if( count($__LIST__)==0 ) : echo "$emp" ;else: foreach($__LIST__ as $key=>$at): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td align="center" ><?php echo ($at["spec_name"]); ?></td>
              <td align="center" ><?php if($at["status"] == 1): ?>启用<?php else: ?><span style="color: red">停用</span><?php endif; ?></td>
              <td align="center" ><?php echo ($at["spec_price"]); ?>元</td>
              <td align="center" >
                <?php echo ($at["typename"]); ?>
              </td>
              <td width="200px" align="center" > 
              <a href="SpecEdit/id/<?php echo ($at["id"]); ?>"><button class="btn btn-default" type="button"><i alt='编辑' title='编辑' class="glyphicon glyphicon-pencil "></i>编辑</button></a>
               </td>
            </tr><?php endforeach; endif; else: echo "$emp" ;endif; ?>
        </table>
        <div style="text-align: center;"></div>
        <div style="text-align: center;">
          <a href="<?php echo U('StoreSpec/SpecAdd');?>"><input  name="submitbtn" class="btn btn-primary" value="添加规格" type="button" /></a> - 
          <a href="SpecDel"><input  name="submitbtn" class="btn btn-primary" onclick="return confirm('您确定要删除选中的规格吗？')" value="删除选中" type="submit" /></a>
