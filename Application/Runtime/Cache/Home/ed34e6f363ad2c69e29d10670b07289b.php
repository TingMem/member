...
<script type="text/javascript">
  $(document).ready(function(){
    $('.sub').click(function(){
      $("#form2").attr('action',$(this).attr('data-url'));
      $('#form2').submit();
    });
  });
</script>
      ...
      <ul>
        <table class="table table-bordered" width="96%" style="background:#fff;"  cellpadding="0">
          <tr>
            ...
            <td align="center" >商家名</td>
            <td align="center" >状态</td>
            <td align="center" >商家地址</td>
            <td align="center" >操作</td>
          </tr>
          <?php if(is_array($spt)): $i = 0; $__LIST__ = $spt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$at): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td align="center" ><?php echo ($at["shopname"]); ?></td>
              <td align="center" ><?php if($at["status"] == 1): ?><span style="color: green">启用</span><?php else: ?><span style="color: red">停用</span><?php endif; ?></td>
              <td align="center"><?php echo ($at["address"]); ?></td>
              <td width="200px" align="center" > 
              <a href="<?php echo U('ShopEdit',array('id'=>$at['id']));?>"><button class="btn btn-default" type="button"><i alt='编辑' title='编辑' class="glyphicon glyphicon-pencil "></i>编辑</button></a>
               </td>
            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
        </table>
        <div style="text-align: center;"></div>
        <div style="text-align: center;">
          <a href="<?php echo U('ShopAdd');?>"><input  name="submitbtn" class="btn btn-primary" value="添加商家" type="button" /></a> - <input  name="submitbtn" data-url="<?php echo U('ShopSaveStatus',array('sta'=>1));?>" class="btn btn-primary sub" value="启用商家" type="submit" /> - <input  name="submitbtn" data-url="<?php echo U('ShopSaveStatus',array('sta'=>0));?>" class="btn btn-primary sub" value="禁用商家" type="submit" /> -
          <input  name="submitbtn" class="btn btn-primary sub" onclick="return confirm('您确定要删除选中的规格吗？')" value="删除选中" type="submit" data-url="ShopDel" />
