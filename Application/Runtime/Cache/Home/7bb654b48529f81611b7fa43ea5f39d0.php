  ...
  <div class="container">
    <div class="row clearfix">
      <div class="col-md-12 column">
        <form class="form-horizontal" enctype="multipart/form-data" role="form" id="form1" name="form1" method="post" action="<?php echo U('TypeAdd');?>">
          <div class="form-group">
            <label for="typename" class="col-sm-2 control-label">分类名</label>
            <div class="col-sm-3">
              <input name="type_name" class="form-control" id="type_name" value="" type="text" />
            </div>
          </div>
          <div class="form-group">
            <label for="type" class="col-sm-2 control-label">分类图标</label>
            <div class="col-sm-2" style="border: 0px;">
              <input name="typepic"  id="typepic" value="" type="file" />

            </div>
            <p class="col-sm-2 text-danger">最大200kb</p>
          </div>
          <div class="form-group">
             <label for="type_status" class="col-sm-2 control-label">立即启用</label>
            <div class="col-sm-2">
          ...
          <div class="form-group">
            <label for="weight" class="col-sm-2 control-label">权重（排序）</label>
            <div class="col-sm-1">
              <input name="weight" class="form-control" id="weight" value="50" type="text" />
            </div>
          </div>
