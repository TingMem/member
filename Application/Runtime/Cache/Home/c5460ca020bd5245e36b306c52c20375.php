  ...
  <div class="container">
    <div class="row clearfix">
      <div class="col-md-12 column">
        <form class="form-horizontal" role="form" id="form1" name="form1" method="post" action="<?php echo U('StoreSpec/SpecAdd');?>">
          <div class="form-group">
            <label for="spec_name" class="col-sm-2 control-label">规格名</label>
            <div class="col-sm-3">
              <input name="spec_name" class="form-control" id="spec_name" type="text" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-1">
              <input name="spec_price" class="form-control" id="spec_price" type="text" />
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              ...
              <?php if(is_array($tm)): $i = 0; $__LIST__ = $tm;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tm): $mod = ($i % 2 );++$i;?><option value="<?php echo ($tm["id"]); ?>"><?php echo ($tm["typename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </div>
          </div>
          <div class="form-group">
