      ...
      <div class="container">
        <div class="row clearfix">
          <div class="col-md-9 column">
            <form class="form-horizonta product-add" name="form1" data-type='ajax' id="form1" method="post" action="<?php echo U('ShopAddAjax');?>" role="form">
              <div class="form-group">
                 <label for="spname">商家名称</label><input placeholder="三娘湾景区" name="shopname" class="form-control" value="" id="shopname" type="text" />
              </div>
              <div class="form-group">
                <label for="title">分类信息</label>
                <div class="form-inline">
                  <select name="typeid" id="typeid" class="form-control">
                    <?php if(is_array($tn)): $i = 0; $__LIST__ = $tn;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tn): $mod = ($i % 2 );++$i;?><option value="<?php echo ($tn["id"]); ?>"><?php echo ($tn["typename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                  </select>
              ...
              <div class="form-group">
                 <label for="spname">商家地址</label><input placeholder="钦州市xxx街xx号" name="address" class="form-control" value="" id="address" type="text" />
              </div>
              <div class="form-group">
              ...
              <div class="form-group"><label for="business_about">商家介绍</label><textarea style="min-height: 300px"  name="business_about" id="business_about"></textarea>
<!-- 配置文件 -->
...
$('form').data('bootstrapValidator').validate(); 
 ...
 if(sub){
    ...
    var data = $('form').serializeArray();//Ajax提交表单
    $.ajax({
      type:'POST',
      datatype:'json',
      data:data,
